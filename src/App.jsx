...
const INITIAL_MD = [
  ...
  '- **9/29 進階測試發現**：問題呈現明顯的時間依賴特性，系統穩定運作約一小時後，觸發遊戲暫停選單時才會誘發 VFIO reset/restore bar 錯誤，根本原因持續追蹤中。',
  '',
  '---',
  '',
  ...
  '# 由於已設定 ASPM OFF，disable_idle_d3 可能不必要甚至有害',
  'options vfio-pci ids=10de:2705,10de:22bb nointxmask=1',
  '',
  '# 如果仍有問題，可嘗試（但可能讓情況更糟）',
  '# options vfio-pci ids=10de:2705,10de:22bb disable_idle_d3=1',
  '```',
  '',
