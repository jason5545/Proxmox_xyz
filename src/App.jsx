...
const INITIAL_MD = [
  ...
  '- **10/1 D3 閒置停用測試中**：`disable_idle_d3=1` 方案持續測試中，監控 GPU 電源狀態與 VFIO 穩定性。目前已完成技術查證，確認此參數為 Kernel 官方提供的 D3cold 問題緩解方案，NVIDIA 工程師於 2022 年提交相關補丁已合併至 Kernel 5.19/6.0。等待長程測試結果驗證方案有效性。',
  '',
  '---',
  '',
  ...
  '- ✅ 部分使用者報告有效',
  '- ❌ 部分使用者報告「讓問題更糟」',
  '- ⚠️ **效果因硬體而異**（ROG STRIX B650-I + RTX 4070 Ti Super 測試中）',
  '',
  ...
  '',
  '3. **disable_idle_d3 是官方建議方案**',
  '   - 出現在 Intel ACC100 官方文件',
  '   - 社群廣泛使用',
  '   - **效果因硬體而異**（需實測驗證）',
  '',
  '4. **如果 disable_idle_d3 無效，有備用方案**',
  '   - Plan B：d3cold_allowed=0',
  '   - Plan C：Runtime PM control=on',
  '   - Plan D：降級 Kernel 或使用 vendor-reset（AMD）',
  '',
  '---',
  '',
  '## 成果與建議',
